...
const sip = require('./sipstack.cjs');
const dgram = require('dgram');
const crypto = require('crypto');
const { readWavPcm16Mono8k, readWavPcm16Mono16k, pcm16ToUlawBuffer, pcm16ToAlawBuffer, pcm16Resample } = require('./wav_utils.cjs');
const { encode: pcm16ToG722Buffer } = require('./g722.cjs');
const stun = require('./stun_client.cjs');
